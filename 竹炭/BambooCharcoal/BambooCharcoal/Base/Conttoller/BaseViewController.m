...
-(void)setLeftWhileArrow
{
    UIButton *button_na = [[UIButton alloc]initWithFrame:CGRectMake(0, 22, 25, 50)];
    [button_na setImage:[UIImage imageNamed:@"whileArrow"] forState:UIControlStateNormal];
...
- (void)compressedVideoOtherMethodWithURL:(NSURL *)url compressionType:(NSString *)compressionType compressionResultPath:(CompressionSuccessBlock)resultPathBlock {
    ...
    if ([compatiblePresets containsObject:compressionType]) {
        ...
        resultPath = [CompressionVideoPaht stringByAppendingPathComponent:[NSString stringWithFormat:@"thyVideo%@.mp4", [formater stringFromDate:[NSDate date]]]];
