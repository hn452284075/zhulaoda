...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        gradebtn.layer.cornerRadius = 8;
        gradebtn.backgroundColor = [UIColor colorWithRed:0xff/255. green:0xff/255. blue:0xff/255. alpha:0.3]; //kGetColor(92, 202, 103);
        ...
        upBtn.titleLabel.font = [UIFont boldSystemFontOfSize:24];
        ...
        [upBtn_1 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(upBtn.mas_bottom).offset(8);
            make.centerX.equalTo(self.mas_centerX).offset(-(kScreenWidth/4));
            make.height.mas_equalTo(15);
            make.width.mas_equalTo(100);
        }];
        ...
        downBtn.titleLabel.font = [UIFont boldSystemFontOfSize:24];
        ...
        [downBtn_1 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(downBtn.mas_bottom).offset(8);
            make.centerX.equalTo(self.mas_centerX).offset((kScreenWidth/4));
            make.height.mas_equalTo(15);
            make.width.mas_equalTo(100);
        }];
...
{
    [self.delegate gradeRuleFunction];
}


- (void)upBtnClicked:(id)sender
{
    [self.delegate upGoodsFunction];
}


- (void)downBtnClicked:(id)sender
{
    [self.delegate downGoodsFunction];
}
