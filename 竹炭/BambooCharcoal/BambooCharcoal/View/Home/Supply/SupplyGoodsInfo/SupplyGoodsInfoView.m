...
- (void)_initGoodsTitleInfo:(NSString *)title price:(NSString *)price unit:(NSString *)unit weight:(NSString *)weight distance:(NSString *)distance see:(NSString *)see
{
    ...
    UILabel *lab8 = [self viewWithTag:8];
    lab8.text = [NSString stringWithFormat:@"/%@",unit];
}
