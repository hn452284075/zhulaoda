...
@property (weak, nonatomic) IBOutlet UIImageView *orderImage2;
@property (weak, nonatomic) IBOutlet UIImageView *orderImage3;
@property (weak, nonatomic) IBOutlet UILabel *orderStatus;
@property (weak, nonatomic) IBOutlet UIButton *storeBtn;
@property (weak, nonatomic) IBOutlet UILabel *orderPrice;
@property (nonatomic,strong)NSDictionary *storeDic;//供应订单
@property (nonatomic,strong)NSDictionary *meOrderDic;//采购订单
@property (weak, nonatomic) IBOutlet UILabel *actualQuantity;
