...
//判断iPhoneX系列
#define IS_Iphonex_Series ((iPhoneX==YES || IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? YES : NO)
...
#define userInfoCacheKey  @"zhutanUserInfoCacheKey"

#define deleteImageUrl @"https://app.zuzitech.com"



#define UserIsLogin [[UserModel sharedInstance] userIsLogin]
